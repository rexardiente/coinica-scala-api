...
@Singleton
class TaskDateService @Inject()(taskRepo: TaskRepo) extends utils.CommonImplicits {

  def paginatedResult[T >: Task](start: Instant, end: Option[Instant], limit: Int, offset: Int): Future[JsValue] = {
