...
import models.domain.{ ChallengeHistory, ChallengeWinner }
...
final class ChallengeHistoryDAO @Inject()(
  ...
  protected class ChallengeHistoryTable(tag: Tag) extends Table[ChallengeHistory](tag, "CHALLENGE_HISTORY") {
    ...
    def winners = column[List[ChallengeWinner]] ("WINNERS")
    def createdAt = column[Instant] ("CREATED_AT")

    def * = (id, challengeID, winners, createdAt) <> (ChallengeHistory.tupled, ChallengeHistory.unapply)
  }
