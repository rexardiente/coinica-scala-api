...
create table "MAHJONG_HILO_HISTORY" ("ID" VARCHAR NOT NULL PRIMARY KEY,"USER_GAME_ID" INTEGER NOT NULL,"PREDICTIONS" VARCHAR NOT NULL,"GAME_DATA" VARCHAR,"GAME_STATUS" BOOLEAN NOT NULL);
