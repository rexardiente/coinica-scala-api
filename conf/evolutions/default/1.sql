...
create table "VIP" ("USER" VARCHAR NOT NULL PRIMARY KEY,"RANK" VARCHAR NOT NULL,"NEXT_RANK" VARCHAR NOT NULL,"PAYOUT" BIGINT NOT NULL,"POINTS" BIGINT NOT NULL,"NEXT_LEVEL" INTEGER NOT NULL,"CREATED_AT" timestamp NOT NULL);

create table "VIP_BENEFITS" ("ID" VARCHAR NOT NULL PRIMARY KEY,"CASH_BACK" DOUBLE PRECISION NOT NULL,"REDEMPTION_RATE" DOUBLE PRECISION NOT NULL,"REFERRAL_RATE" DOUBLE PRECISION NOT NULL,"CLOSED_BETA" BOOLEAN NOT NULL,"CONCIERGE" BOOLEAN NOT NULL,"AMOUNT" BIGINT NOT NULL,"POINTS" BIGINT NOT NULL);
