...
create table "VIP" ("ID" UUID NOT NULL PRIMARY KEY,"RANK" VARCHAR NOT NULL,"NEXT_RANK" VARCHAR NOT NULL,"REFERRAL_COUNT" INTEGER NOT NULL,"PAYOUT" BIGINT NOT NULL,"POINTS" BIGINT NOT NULL,"UPDATED_AT" timestamp NOT NULL);
