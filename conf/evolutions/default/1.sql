...
create table "ADMIN_AUTH" ("ID" UUID NOT NULL PRIMARY KEY,"EMAIL" VARCHAR NOT NULL,"ROLE" VARCHAR NOT NULL,"CREATED_AT" timestamp NOT NULL,"HASHED_PASSWORD" VARCHAR NOT NULL,"VERIFICATION_INITIAL_TIME" timestamp,"RESET_PASSWORD_CODE" VARCHAR,"NEW_EMAIL" VARCHAR,"NEW_EMAIL_CODE" VARCHAR,"DISABLED_AT" timestamp);
