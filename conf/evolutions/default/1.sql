...
create table "TRANSACTION" ("ID" UUID NOT NULL,"TRACE_ID" VARCHAR NOT NULL,"BLOCK_NUM" BIGINT NOT NULL,"BLOCK_TIMESTAMP" timestamp NOT NULL,"TRACE" VARCHAR NOT NULL);
