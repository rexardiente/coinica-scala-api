...
create table "GQ_CHARACTER_GAME_HISTORY" ("GAME_ID" VARCHAR NOT NULL PRIMARY KEY,"PLAYER" VARCHAR NOT NULL,"ENEMY" VARCHAR NOT NULL,"PLAYER_ID" VARCHAR NOT NULL,"ENEMY_ID" VARCHAR NOT NULL,"TIME_EXECUTED" BIGINT NOT NULL,"GAME_LOG" text [] NOT NULL,"IS_WIN" BOOLEAN NOT NULL);
