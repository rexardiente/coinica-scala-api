...
create table "GQ_CHARACTER_DATA_HISTORY" ("CHARACTER_ID" VARCHAR NOT NULL PRIMARY KEY,"PLAYER" VARCHAR NOT NULL,"LIFE" INTEGER NOT NULL,"HP" INTEGER NOT NULL,"CLASS" INTEGER NOT NULL,"LEVEL" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACT" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" VARCHAR NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"LAST_MATCH" BIGINT NOT NULL);
