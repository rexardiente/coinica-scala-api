...
create table "USER_ACCOUNT_WALLET" ("ID" UUID NOT NULL PRIMARY KEY,"BTC" DOUBLE PRECISION NOT NULL,"ETH" DOUBLE PRECISION NOT NULL,"USDT" DOUBLE PRECISION NOT NULL);
