...
create table "RANKING" ("ID" INTEGER NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"BETS" DOUBLE PRECISION NOT NULL,"PROFIT" DOUBLE PRECISION NOT NULL,"MULTIPLIERAMOUNT" DOUBLE PRECISION NOT NULL,"RANKINGCREATED" BIGINT NOT NULL);
...
create table "GQ_CHARACTER_DATA" ("CHARACTER_ID" VARCHAR NOT NULL PRIMARY KEY,"OWNER" VARCHAR NOT NULL,"LIFE" INTEGER NOT NULL,"INITIAL_HP" INTEGER NOT NULL,"HIT_POINTS" INTEGER NOT NULL,"CLASS" INTEGER NOT NULL,"LEVEL" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACK" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" VARCHAR NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"LAST_MATCH" BIGINT NOT NULL);
...
create table "GQ_CHARACTER_DATA_HISTORY" ("CHARACTER_ID" VARCHAR NOT NULL PRIMARY KEY,"PLAYER" VARCHAR NOT NULL,"ENEMY" INTEGER NOT NULL,"HP" INTEGER NOT NULL,"HIT_POINTS" INTEGER NOT NULL,"CLASS" INTEGER NOT NULL,"LEVEL" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACT" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" VARCHAR NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"LAST_MATCH" BIGINT NOT NULL);
