...
create table "TRANSACTION" ("ID" UUID NOT NULL PRIMARY KEY,"TX_ID" VARCHAR NOT NULL,"STATUS" VARCHAR NOT NULL,"CPU_USAGE_US" INTEGER NOT NULL,"NET_USAGE_WORDS" INTEGER NOT NULL,"ELAPSED" INTEGER NOT NULL,"NET_USAGE" INTEGER NOT NULL,"SCHEDULED" BOOLEAN NOT NULL,"ACT_TRACES" VARCHAR NOT NULL,"ACC_RAM_DELTA" VARCHAR NOT NULL,"EXCEPT" VARCHAR NOT NULL,"ERR_CODE" VARCHAR NOT NULL,"FAILED_DTRX_TRACE" VARCHAR NOT NULL,"PARTIAL" VARCHAR NOT NULL,"DATE" timestamp NOT NULL);
