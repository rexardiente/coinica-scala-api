...
create table "REFERRAL" ("ID" UUID NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"GAME_ID" UUID NOT NULL,"IMG_URL" VARCHAR NOT NULL,"AMOUNT" DOUBLE NOT NULL,"REFERRALCREATED" BIGINT NOT NULL);
...
alter table "TRANSACTION" add constraint "pk_a" primary key("ID","TRACE_ID");



# --- !Downs

alter table "TRANSACTION" drop constraint "pk_a";
