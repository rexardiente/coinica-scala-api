...
create table "OVER_ALL_GAME_HISTORY" ("ID" UUID NOT NULL PRIMARY KEY,"TX_HASH" VARCHAR NOT NULL,"GAME_ID" UUID NOT NULL,"GAME" VARCHAR NOT NULL,"TYPE" VARCHAR NOT NULL,"IS_CONFIRMED" BOOLEAN NOT NULL,"CREATED_AT" BIGINT NOT NULL);
