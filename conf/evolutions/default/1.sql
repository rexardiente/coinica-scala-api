...
create table "USER_ACCOUNT" ("ID" UUID NOT NULL PRIMARY KEY,"USERNAME" VARCHAR NOT NULL,"PASSWORD" VARCHAR NOT NULL,"EMAIL_ADDRESS" VARCHAR,"REFERRED_BY" VARCHAR,"REFERRAL_CODE" VARCHAR NOT NULL,"REFERRAL_AMOUNT" DOUBLE PRECISION NOT NULL,"REFERRAL_RATE" DOUBLE PRECISION NOT NULL,"WIN_RATE" DOUBLE PRECISION NOT NULL,"IS_VERIFIED" BOOLEAN NOT NULL,"LAST_SIGN_IN" timestamp NOT NULL,"CREATED_AT" timestamp NOT NULL);

create table "USER_TOKEN" ("ID" UUID NOT NULL PRIMARY KEY,"TOKEN" VARCHAR,"LOGIN" BIGINT,"EMAIL" BIGINT,"PASSWORD" BIGINT);

create table "VIP_ACCOUNT" ("ID" UUID NOT NULL PRIMARY KEY,"RANK" VARCHAR NOT NULL,"NEXT_RANK" VARCHAR NOT NULL,"REFERRAL_COUNT" INTEGER NOT NULL,"PAYOUT" DOUBLE PRECISION NOT NULL,"POINTS" DOUBLE PRECISION NOT NULL,"UPDATED_AT" timestamp NOT NULL);
...
alter table "USER_TOKEN" add constraint "USER_ACCOUNT" foreign key("ID") references "USER_ACCOUNT"("ID") on update NO ACTION on delete NO ACTION;

alter table "VIP_ACCOUNT" add constraint "USER_ACCOUNT" foreign key("ID") references "USER_ACCOUNT"("ID") on update NO ACTION on delete NO ACTION;



# --- !Downs

alter table "VIP_ACCOUNT" drop constraint "USER_ACCOUNT";
alter table "USER_TOKEN" drop constraint "USER_ACCOUNT";
