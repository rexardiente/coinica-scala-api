...
create table "USER_ACCOUNT" ("ID" UUID NOT NULL PRIMARY KEY,"USERNAME" VARCHAR NOT NULL,"PASSWORD" VARCHAR NOT NULL,"EMAIL_ADDRESS" VARCHAR,"REFERRED_BY" VARCHAR,"REFERRAL_CODE" VARCHAR NOT NULL,"REFERRAL_AMOUNT" DOUBLE PRECISION NOT NULL,"REFERRAL_RATE" DOUBLE PRECISION NOT NULL,"WIN_RATE" DOUBLE PRECISION NOT NULL,"SESSION_TOKEN" VARCHAR,"SESSION_TOKEN_LIMIT" BIGINT,"IS_VERIFIED" BOOLEAN NOT NULL,"LAST_SIGN_IN" timestamp NOT NULL,"CREATED_AT" timestamp NOT NULL);

create table "USER_TOKENS" ("ID" UUID NOT NULL PRIMARY KEY,"TOKEN" VARCHAR,"LOGIN" BIGINT,"EMAIL" BIGINT,"PASSWORD" BIGINT);
