...
create table "GHOST_QUEST_CHARACTER_HISTORY" ("KEY" VARCHAR NOT NULL,"OWNER_ID" INTEGER NOT NULL,"GHOST_NAME" VARCHAR NOT NULL,"GHOST_ID" INTEGER NOT NULL,"RARITY" INTEGER NOT NULL,"LIFE" INTEGER NOT NULL,"INITIAL_HP" INTEGER NOT NULL,"HIT_POINTS" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACK" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" DECIMAL(21,2) NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"CREATED_AT" VARCHAR NOT NULL,"LAST_MATCH" INTEGER NOT NULL,"MATCHES" VARCHAR NOT NULL);
