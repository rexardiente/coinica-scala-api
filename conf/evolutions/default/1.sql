...
create table "RANKING" ("ID" INT NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"BETS" DOUBLE PRECISION NOT NULL,"PROFIT" DOUBLE PRECISION NOT NULL,"MULTIPLIERAMOUNT" DOUBLE PRECISION NOT NULL,"RANKINGCREATED" BIGINT NOT NULL);
...
create table "GQ_CHARACTER_DATA" ("ID" UUID NOT NULL PRIMARY KEY,"CHARACTER_ID" BIGINT NOT NULL,"OWNER" VARCHAR NOT NULL,"LIFE" INTEGER NOT NULL,"INITIAL_HP" INTEGER NOT NULL,"HIT_POINTS" INTEGER NOT NULL,"CLASS" INTEGER NOT NULL,"LEVEL" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACK" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" VARCHAR NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"LAST_MATCH" BIGINT NOT NULL);

create table "GQ_CHARACTER_GAME_HISTORY" ("ID" UUID NOT NULL PRIMARY KEY,"GAME_ID" VARCHAR NOT NULL,"PLAYER" VARCHAR NOT NULL,"ENEMY" VARCHAR NOT NULL,"PLAYER_ID" BIGINT NOT NULL,"ENEMY_ID" BIGINT NOT NULL,"TIME_EXECUTED" BIGINT NOT NULL,"GAME_LOG" text [] NOT NULL,"IS_WIN" BOOLEAN NOT NULL);

create table "GQ_CHARACTER_DATA_HISTORY" ("ID" UUID NOT NULL PRIMARY KEY,"CHARACTER_ID" BIGINT NOT NULL,"PLAYER" VARCHAR NOT NULL,"ENEMY" INTEGER NOT NULL,"HP" INTEGER NOT NULL,"HIT_POINTS" INTEGER NOT NULL,"CLASS" INTEGER NOT NULL,"LEVEL" INTEGER NOT NULL,"STATUS" INTEGER NOT NULL,"ATTACT" INTEGER NOT NULL,"DEFENSE" INTEGER NOT NULL,"SPEED" INTEGER NOT NULL,"LUCK" INTEGER NOT NULL,"PRIZE" VARCHAR NOT NULL,"BATTLE_LIMIT" INTEGER NOT NULL,"BATTLE_COUNT" INTEGER NOT NULL,"LAST_MATCH" BIGINT NOT NULL,"MATCHES" INTEGER NOT NULL);
